    ...
    >
      ...
      <View style={style.containerSecao}>
        ...
        <View style={[style.boxSecao, { backgroundColor: '#4281A4' }]}>
            <Text style={style.txtSecao}>
            Brasil
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://imgs.search.brave.com/u4pAQjUXy45iBhbPqRl6S25bIgkJJh2hrOrZRg3eazE/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9wb3J0/YWxwb3BsaW5lLmNv/bS5ici93cC1jb250/ZW50L3VwbG9hZHMv/MjAyMS8xMS9tYXJp/bGlhLW1lbmRvbmNh/LWdyYW1teS0yLmpw/Zw"}} />
        </View>
        ...
        <View style={[style.boxSecao, { backgroundColor: '#220C10' }]}>
            ...
            <Image style={style.imgSecao} source={{uri:"https://imgs.search.brave.com/IX4QRd9qnXMxiBRkGrRCHSAvMcnhi-kZF1kyQwVJoIs/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/dmFnYWx1bWUuY29t/LmJyL3RoZS13ZWVr/bmQvZGlzY29ncmFm/aWEvc3RhcmJveS53/ZWJw"}} />
        </View>
        <View style={[style.boxSecao, { backgroundColor: '#202030' }]}>
            <Text style={style.txtSecao}>
             Podcast
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://i.scdn.co/image/ab67656300005f1f7fbf5d3b676ba83b4a1867b3"}} />
        </View>
        <View style={[style.boxSecao, { backgroundColor: '#36213E' }]}>
            <Text style={style.txtSecao}>
             Eventos Ao Vivo
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://imgs.search.brave.com/xpQQUh91yJQAe5MzGTnO3M9CWSh38KDCg7oWMSRAxRA/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9jZG4u/cGl4YWJheS5jb20v/cGhvdG8vMjAxNy8w/NC8xMC8xNi81NS9s/aXZlLW11c2ljLTIy/MTkwMzZfNjQwLmpw/Zw"}} />
        </View>
        <View style={[style.boxSecao, { backgroundColor: '#220C10' }]}>
            <Text style={style.txtSecao}>
             Feito para você
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://imgs.search.brave.com/XiQTHMlRFfESIC8AUo2zzsZ-vUoG3aciTNRLKywr2kg/rs:fit:500:0:0:0/g:ce/aHR0cHM6Ly93d3cu/dmFnYWx1bWUuY29t/LmJyL3NsaXBrbm90/L2ltYWdlcy9zbGlw/a25vdC5qcGc"}} />
        </View>
        <View style={[style.boxSecao, { backgroundColor: '#4281A4' }]}>
            <Text style={style.txtSecao}>
             Lançamentos
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://i.scdn.co/image/ab67616d00001e02229a333e30908975e7724646"}} />
        </View>
        <View style={[style.boxSecao, { backgroundColor: 'rgb(45, 70, 185)' }]}>
            <Text style={style.txtSecao}>
             São João
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://i.scdn.co/image/ab67fb8200005cafaee353b8cd0f7f14197c5565"}} />
        </View>
        <View style={[style.boxSecao, { backgroundColor: 'rgb(30, 50, 100)' }]}>
            <Text style={style.txtSecao}>
            Originais do Spotify
            </Text>
            <Image style={style.imgSecao} source={{uri:"https://i.scdn.co/image/ab67656300005f1fb02b40e89324364b8b5f75b2"}} />
        </View>
